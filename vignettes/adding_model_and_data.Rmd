...
```{r, eval=FALSE}
main2 <- "~/sandbox2"
setup_sandbox(main = main2, new_model_controls = new_controls, models = c(prefab_models(), "newmod"))
```
...
```{r, eval=FALSE}
main3 <- "~/sandbox3"
setup_sandbox(main = main3, new_dataset_controls = new_controls, datasets = c(prefab_models(), "newdata"))
```