...
We currently analyze and forecast rodent data at Portal using seven models: ESSS, AutoArima, NaiveArima, nbGARCH, nbsGARCH, pevGARCH, and simplexEDM [@PortalPredictions]. Each model has a function with its name (*e.g.*, `ESSS()`) which is called from an associated R script in the `models` subdirectory with its name (*e.g.*, `ESSS.R`)
