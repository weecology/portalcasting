...
We currently analyze and forecast rodent data at Portal using six models: ESSS, AutoArima, NaiveArima, nbGARCH, nbsGARCH, and pevGARCH [@PortalPredictions]. Each model has a function with its name (*e.g.*, `ESSS()`) which is called from an associated R 
