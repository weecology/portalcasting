...
* `fill_resources` downloads each of the resources for the directory, which presently include the source data (rodents), covariate data (weather, NDVI), and previous forecasts' archive. Upon completion of the downloads, `fill_resource` updates `directory_configuration.yaml` with downloaded versions.
