...
ESSS, AutoArima, nbGARCH, and pevGARCH [@PortalPredictions]. Each model
has a function with its name (*e.g.*, `ESSS()`) and an associated R script
in the `models` subdirectory with its name (*e.g.*, `ESSS.R`)
