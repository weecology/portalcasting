...
And `read_cast_tab`, `read_model_cast`, and `read_forecasts_metadata` each read in the associated output from a given cast, as indicated by its forecast_id, which is displayed in the output from `select_forecasts`:
