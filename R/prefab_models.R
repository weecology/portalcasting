...
AutoArima <- function(main = ".", data_set = "all", quiet = FALSE, 
  ...
  sp_col <- is_sp_col(rodents_table, total = TRUE, nadot = TRUE)
  species <- colnames(rodents_table)[sp_col]
