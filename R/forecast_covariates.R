...
#'
#' @param covariate_data \code{data.frame} of historical covariate data 
#'   generated by \code{\link{prep_hist_covariates}}.
#'
#' @param moons \code{data.frame} containing the historic and future newmoons,
#'   as produced by \code{\link{prep_moons}}.
#'
