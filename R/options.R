...
#'
#' @param length for get_rodent_data, automatically set by tmnt_type
#'
...
all_options <- function(base = "~", main = "forecasting", subs = subdirs(), 
                        ...
                        start = 217, drop_spp = "PI", min_plots = 24, 
                        level = "Site", treatment = NULL, length = "all",
...
data_options <- function(base = "~", main = "forecasting", subs = subdirs(),
  ...
  list(
    ...
    rodents = rodents_options(tmnt_type = tmnt_type, start = start, 
                              drop_spp = drop_spp, min_plots = min_plots, 
                              level = level, treatment = treatment, 
                              length = length, output = output,
...
#' @export
#'
rodents_options <- function(tmnt_type = NULL, start = 217, drop_spp = "PI", 
  ...
  list(start = start, drop_spp = drop_spp, min_plots = min_plots, 
       tmnt_type = tmnt_type, level = level, length = length, output = output,
