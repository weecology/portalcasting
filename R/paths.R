...
#'              the directory tree. 
#'
#' @param subs \code{character} of the name(s) of the sub component(s) of
#'              the directory tree. can take a vector of multiple values.
#'
#' @return \code{character} \code{\link{normalized_file_path}}(s).
#'          \cr \cr
#'          \code{main_path} normalized path of the \code{main} folder.
#'          \cr \cr
#'          \code{subs_path} normalized paths of the \code{sub} folder(s). 
#'
#' @name paths
#'
NULL
...
sub_path <- function (main = ".", subs = NULL) {
  ...
  normalized_file_path(main, subs,
                       mustWork = FALSE)
