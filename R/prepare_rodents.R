...
#'  \code{controls_r} will throw an error. \cr \cr 
#'  If any user-defined \code{controls_r} duplicate any existing controls for
#'  the prefab data sets or if \code{controls_r} contains any duplicate named
