...
#  jags modeling
#
#    random walk overall density
#
#  we have not yet added the forecasting
#

#
#  THIS MODEL WILL REPLACE jags_RW, WHICH HAS A BUG!
#
...
plot(modd, vars = c("log_x1", "tau_delta"))
