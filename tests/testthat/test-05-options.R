...
test_that("all_options", {
  ...
  expect_error(all_options(subs = "ok"))
  expect_error(all_options(quiet = 1))
  expect_error(all_options(quiet = c(TRUE, FALSE)))
  expect_error(all_options(fdate = 1))
  expect_error(all_options(fdate = c(today(), today())))
  ...
  expect_is(all_options(model = models("AutoArima")), "all_options")
})
...
test_that("PortalData_options", {
  ...
  expect_error(PortalData_options(subs = "ok"))
...
test_that("data_options", {
  ...
  expect_error(data_options(subs = "ok"))
  expect_error(data_options(quiet = 1))
  expect_error(data_options(quiet = c(TRUE, FALSE)))
  expect_error(data_options(fdate = 1))
  expect_error(data_options(fdate = c(today(), today())))
...
test_that("covariates_options", {
  ...
  expect_error(covariates_options(fdate = 1))
  expect_error(covariates_options(fdate = c(today(), today())))
...
test_that("metadata_options", {
  ...
  expect_error(metadata_options(fdate = 1))
  expect_error(metadata_options(fdate = c(today(), today())))
...
test_that("models_options", {
  ...
  expect_is(models_options(model = models("AutoArima")), 
            "models_options")
  expect_error(models_options(model = "AutoArima"))
})
...
test_that("cast_options", {
  ...
  expect_is(cast_options(model = models("AutoArima")), 
            "cast_options")
  expect_error(cast_options(model = "AutoArima"))
  expect_error(cast_options(fdate = 1))
  expect_error(cast_options(fdate = c(today(), today())))
...
test_that("check_options_args", {
  expect_error(check_options_args(base = c("ok", "ok")))
  expect_error(check_options_args(main = c("ok", "ok")))
  expect_error(check_options_args(base = 1))
  expect_error(check_options_args(main = 1))
  expect_error(check_options_args(subs = "ok"))
  expect_error(check_options_args(quiet = 1))
  expect_error(check_options_args(quiet = c(TRUE, FALSE)))
  expect_error(check_options_args(fdate = 1))
  expect_error(check_options_args(fdate = c(today(), today())))
  expect_error(check_options_args(append_missing_to_raw = 1))
  expect_error(check_options_args(append_missing_to_raw = c(TRUE, FALSE)))
  expect_error(check_options_args(m_save = 1))
  expect_error(check_options_args(m_save = c(TRUE, FALSE)))
  expect_error(check_options_args(start = NULL))
  expect_error(check_options_args(start = "a"))
  expect_error(check_options_args(start = c(1, 2)))
  expect_error(check_options_args(start = 1.5))
  expect_error(check_options_args(end = "a"))
  expect_error(check_options_args(end = 1.5))
  expect_error(check_options_args(hind_step = NULL))
  expect_error(check_options_args(hind_step = "a"))
  expect_error(check_options_args(hind_step = c(1, 2)))
  expect_error(check_options_args(hind_step = 1.5))
  expect_error(check_options_args(drop_spp = 1))
  expect_error(check_options_args(min_plots = NULL))
  expect_error(check_options_args(min_plots = "a"))
  expect_error(check_options_args(min_plots = c(1, 2)))
  expect_error(check_options_args(min_plots = 1.5))
  expect_error(check_options_args(min_traps = NULL))
  expect_error(check_options_args(min_traps = "a"))
  expect_error(check_options_args(min_traps = c(1, 2)))
  expect_error(check_options_args(min_traps = 1.5))
  expect_error(check_options_args(treatment = 1))
  expect_error(check_options_args(level = 1))
  expect_error(check_options_args(output = 1))
  expect_error(check_options_args(plots = "ok"))
  expect_error(check_options_args(r_save = 1))
  expect_error(check_options_args(r_save = c(TRUE, TRUE)))
  expect_error(check_options_args(r_filename = 1))
  expect_error(check_options_args(r_filename = c("ok.csv", "ok.csv")))
  expect_error(check_options_args(cov_fcast = 1))
  expect_error(check_options_args(cov_fcast = c(TRUE, FALSE)))
  expect_error(check_options_args(cov_hist = 1))
  expect_error(check_options_args(cov_hist = c(TRUE, FALSE)))
  expect_error(check_options_args(yr = NULL))
  expect_error(check_options_args(yr = "a"))
  expect_error(check_options_args(yr = c(1, 2)))
  expect_error(check_options_args(yr = 1.5))
  expect_error(check_options_args(min_lag = NULL))
  expect_error(check_options_args(min_lag = "a"))
  expect_error(check_options_args(min_lag = c(1, 2)))
  expect_error(check_options_args(min_lag = 1.5))
  expect_error(check_options_args(lead_time = NULL))
  expect_error(check_options_args(lead_time = "a"))
  expect_error(check_options_args(lead_time = c(1, 2)))
  expect_error(check_options_args(lead_time = 1.5))
  expect_error(check_options_args(fcast_nms = "a"))
  expect_error(check_options_args(fcast_nms = c(1, 2.5)))
  expect_error(check_options_args(fcast_nms = 1.5))
  expect_error(check_options_args(nfcnm = "a"))
  expect_error(check_options_args(nfcnm = c(1, 2)))
  expect_error(check_options_args(nfcnm = 1.5))
  expect_error(check_options_args(append_fcast_csv = 1))
  expect_error(check_options_args(append_fcast_csv = c(TRUE, TRUE)))
  expect_error(check_options_args(c_save = 1))
  expect_error(check_options_args(c_save = c(TRUE, TRUE)))
  expect_error(check_options_args(meta_save = 1))
  expect_error(check_options_args(meta_save = c(TRUE, TRUE)))
  expect_error(check_options_args(download_existing_predictions = 1))
  expect_error(check_options_args(download_existing_predictions = 
                                  c(TRUE, TRUE)))
  expect_error(check_options_args(ensemble = 1))
  expect_error(check_options_args(ensemble = c(TRUE, TRUE)))
  expect_error(check_options_args(from_zenodo = 1))
  expect_error(check_options_args(from_zenodo = c(TRUE, TRUE)))
  expect_error(check_options_args(hist_fcast_file = 1))
  expect_error(check_options_args(hist_fcast_file = c("ok.csv", "ok.csv")))
  expect_error(check_options_args(c_filename = 1))
  expect_error(check_options_args(c_filename = c("ok.csv", "ok.csv")))
  expect_error(check_options_args(meta_filename = 1))
  expect_error(check_options_args(meta_filename = c("ok.csv", "ok.csv")))
  expect_error(check_options_args(m_filename = 1))
  expect_error(check_options_args(m_filename = c("ok.csv", "ok.csv")))
  expect_error(check_options_args(source_name = 1))
  expect_error(check_options_args(source_name = c("ok", "ok")))
  expect_error(check_options_args(cast_type = 1))
  expect_error(check_options_args(cast_type = c("forecasts", "forecasts")))
  expect_error(check_options_args(cast_type = "ok"))
  expect_error(check_options_args(version = 1))
  expect_error(check_options_args(version = c("latest", "latest")))
  expect_error(check_options_args(confidence_level = "a"))
  expect_error(check_options_args(confidence_level = c(0.1, 0.2)))
  expect_error(check_options_args(confidence_level = 1.5))
  expect_error(check_options_args(confidence_level = -0.5))
  expect_error(check_options_args(model = "AutoArima"))
  expect_error(check_options_args(tmnt_type = "ok"))
  expect_error(check_options_args(n_future_moons = "a"))
  expect_error(check_options_args(n_future_moons = c(1, 2)))
  expect_error(check_options_args(n_future_moons = 1.5))
  expect_error(check_options_args(save = 1))
  expect_error(check_options_args(save = c(TRUE, FALSE)))
  expect_error(check_options_args(filename = 1))
  expect_error(check_options_args(filename = c("ok.csv", "ok.csv")))
  expect_error(check_options_args(tree = 1))
})