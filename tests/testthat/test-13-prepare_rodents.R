...
test_that("rodent_spp", {
  ...
  expect_silent(spp <- rodent_spp(species_set = "wtotal"))
  expect_is(spp, "character")
  expect_equal(length(spp), 22)
  expect_silent(spp <- rodent_spp(species_set = "evalplot"))
  expect_is(spp, "character")
  expect_equal(length(spp), 7)
  expect_error(rodent_spp("1"))
  expect_silent(spp <- rodent_spp(nadot = TRUE))
  expect_is(spp, "character")
  expect_equal(length(spp), 21)
})
