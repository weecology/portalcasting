...
test_that(desc = "read_cast_tabs reads in multiple cast tabs", {
  ...
  expect_is(read_cast_tabs(main = main3, cast_ids = NULL), "data.frame")
  expect_is(read_cast_tabs(main = main3, cast_ids = c("1.01", "1.02")), "data.frame")
...
test_that(desc = "read_cast_metadata reads in the metadata", {
  ...
  expect_is(read_cast_metadata(main = main3, cast_id = NULL), "list")
  expect_error(read_cast_metadata(main = main3, cast_id = 1e10))
...
test_that(desc = "read_model_fit reads in model fits", {
  ...
  #expect_is(read_model_fit(main = main3, cast_id = NULL), "list")
  expect_error(read_model_fit(main = main3, cast_id = 1e10))
...
test_that(desc = "add_obs_to_cast_tab functions add properly", {
  ...
  skip_on_cran() 
   ...
   cast_tab <- read_cast_tab(main = main3, cast_id = "1.01")
...
test_that(desc = "read_model_cast reads in model casts", {
  ...
  ok <- read_model_cast(main = main3, cast_id = NULL)
  expect_error(read_model_cast(main = main3, cast_id = 1e10))
