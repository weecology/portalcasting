...
test_that("prep_moons", {
  expect_error(prep_moons(1))
  expect_message(moons <- prep_moons(moons_opts))
  expect_is(moons, "moons")
})

test_that("append_past_moons_to_raw", {
  expect_error(append_past_moons_to_raw(moons, 1))
  expect_error(append_past_moons_to_raw(1, moons_opts))
  expect_is(append_past_moons_to_raw(moons, moons_opts), "moons")
})

test_that("add_future_moons", {
  expect_error(add_future_moons(moons, 1))
  expect_error(add_future_moons(1, moons_opts))
...
test_that("add_addl_future_moons", {
  ...
  expect_error(add_addl_future_moons(future_moons, 1))
  expect_error(add_addl_future_moons(1, cast_date))
